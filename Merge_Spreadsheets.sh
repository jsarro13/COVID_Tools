...
#Creates a super table for Covid-seq runs. Used 4 tables. The Dragen Dataexport, Dragen probe export, table generated by Gather_num_reads_only_Stats.sh, and a master list containing Ct vlaues.
###parse Dragen info
